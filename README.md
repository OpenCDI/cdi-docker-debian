...
You can also make containerized desktop environment, which is more tolerant to data breaching from ordinal (unsandboxed) desktop environment.
...
```
docker pull coshapp/core:debian-10.10
```
